            ...
            >
                ...
                <div style={{ position: 'relative', zIndex: 1, width: '210px', height: '210px', display: 'grid', placeItems: 'center' }}>
                    ...
                    <span
                        ...
                        style={{
                            position: 'relative', width: '112px', height: '112px', display: 'grid', placeItems: 'center',
                            filter: 'drop-shadow(0 14px 30px rgba(27,23,18,0.4))',
                        }}
                    >
                        <Logo size={112} color={tokens.ink} />
                    </span>
                </div>
